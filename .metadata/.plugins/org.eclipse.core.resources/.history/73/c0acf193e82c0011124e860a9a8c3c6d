...
AiDifficulty ui_ask_ai_difficulty(void)
{
    ...
    while (1)
    {
        key = input_get_menu_choice_1_to_3();
...
void ui_show_ai_difficulty(AiDifficulty difficulty)
{
    printf("KI-Schwierigkeit: %s\r\n", aiDifficultyToString(difficulty));
}
